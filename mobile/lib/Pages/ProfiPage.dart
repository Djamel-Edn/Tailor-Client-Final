      ...
      child: DefaultTabController(
        ...
        child: Scaffold(
          body: Consumer<TailorsProvider>(
            builder: (context, tailorclient, child) {
              for (var tailor in tailorclient.AllTailors) {
                print("ppppppppppppppppp $tailor");
                if (tailor.id == widget.tailor.id) {
                  widget.tailor.reviews = tailor.reviews;
                }
              }
                                  ...
                                  ? InkWell(
                                      onTap: () async {
                                        await RevLogique.AddFavTailor(
                                            ...
                                            context);
                                        collecFavs
                                            .addOrdeletFav(widget.tailor.id);
                                      ...
                                      child: TabBarView(children: [
                                        ...
                                        Padding(
                                          ...
                                          child: ListView.builder(
                                            ...
                                            itemBuilder: (context, index) {
                                              print(
                                                  "szzzzzzzzzzzzdddddddddddddd  ${widget.tailor.reviews!}");
                                              return Container(
                                                          ...
                                                          child: CircleAvatar(
                                                              backgroundImage: widget
                                                                  ...
                                                                  ? MemoryImage(
                                                                      base64Decode(widget
                                                                          .tailor
                                                                          .reviews![index]["client"]["profilePicture"]))
                                                                  : AssetImage(
                                                                      "images/profileimage.png",
                                                                    ) as ImageProvider),
                                                        ),
