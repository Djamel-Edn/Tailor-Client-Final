...
class _VerifyState extends State<Verify> {
  ...
  //             content:
  //                 const Text('The entered OTP is invalid. Please try again.'),
  //             actions: [
  //               TextButton(
  ...
  //           content: Text(
  //               'Failed to verify OTP. Error code :'),
  //           actions: [
  //             TextButton(
  //               onPressed: () => Navigator.pop(context),
  //               child: const Text('OK'),
                                ...
                                onTap: () {
                                  ...
                                  if (widget.index == 1) {
                                    ...
                                    String otpstr = _otpControllers[0].text +
                                        ...
                                        _otpControllers[3].text;
                                    print("id of tailor");
                                    print(Provider.of<TailorsProvider>(context,
                                            listen: false)
                                        .tailor!
                                        .id);
                                    if (Provider.of<TailorsProvider>(context,
                                                listen: false)
                                            .tailor !=
                                        null) {
                                      Register.VerfiOTP(
